...
$result = $con->query("SELECT balance FROM useraccounts WHERE id = '$userId' LIMIT 1");
$userBalance = 0;
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
     ...
     <?php if(!isset($_SESSION['userId'])) { ?>
      ...
      <a href="chooseSignup.php" class="btn btn-success">Signup</a>
    <?php } else { 
...
<div class="row w-100" >
  <div class="col" style="padding: 22px;padding-top: 0">
      <div class="jumbotron shadowBlack" style="padding: 25px; min-height: 241px; max-height: 241px; background-image: url('images/welcome-bg.jpg'); background-size: cover; background-position: center; background-repeat: no-repeat; color: white;">

  <h3 class="display-5">Welecome to MCB Bank</h3>
  <p class="lead alert alert-warning"><b>Banking service made easy for you!</b><p/>
