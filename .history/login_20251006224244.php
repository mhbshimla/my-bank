...
<!-- <footer class="bg-success text-white pt-5 pb-3 mt-auto"> -->
  ...
  <div class="container">
    <div class="row">
      ...
      <!-- About Section -->
      <div class="col-md-4">
        <h5 class="text-uppercase mb-3 small">About <?php echo bankName; ?></h5>
        <p class="text-sm">
      ...
      <!-- Quick Links -->
      <div class="col-md-2">
        <h5 class="text-uppercase mb-3 small">Quick Links</h5>
      ...
      <!-- Contact Info -->
      <div class="col-md-3">
        <h5 class="text-uppercase mb-3 small">Contact Us</h5>
      ...
      <!-- Social Media -->
      <div class="col-md-3">
        <h5 class="text-uppercase mb-3 small">Follow Us</h5>
