...
<div class="card w-100 text-center shadowWhite">
  ...
  <div class="card-body">
    <form method="GET" class="form-inline mb-3">
       <input type="text" name="search" class="form-control mr-2" placeholder="Search by name, account no, or branch" value="<?php echo isset($_GET['search']) ? $_GET['search'] : '' ?>">
...
if (!empty($search)) {
  $sql = "SELECT * FROM useraccounts, branch 
          WHERE useraccounts.branch = branch.branchId 
          AND (useraccounts.name LIKE '%$search%' 
