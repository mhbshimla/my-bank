...
<!-- <body style="background: url(images/bg-login2.jpg); background-size: cover; min-height:100vh; display:flex; flex-direction:column;"> -->
  <body class="bg-[url('images/bg-login2.jpg')] bg-cover min-h-screen flex flex-col">
...
<!-- <footer class="bg-success text-white pt-5 pb-3 mt-auto"> -->
  <footer class="bg-green-600 text-white pt-5 pb-3 mt-auto shadow-lg border-t border-white/20 backdrop-blur-sm">
  <div class="container">
    <div class="row">
      
      <!-- About Section -->
      <div class="col-md-4">
        <h5 class="text-uppercase mb-3">About <?php echo bankName; ?></h5>
        <p>
