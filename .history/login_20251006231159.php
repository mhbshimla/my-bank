  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-4 text-sm">
        <h5 class="text-uppercase mb-1 mt-1">About <?php echo bankName; ?></h5>
        <p class="text-sm">
      ...
      <!-- Quick Links -->
      <div class="col-md-2">
        <h5 class="text-uppercase mb-1 mt-1">Quick Links</h5>
      ...
      <!-- Contact Info -->
      <div class="col-md-3">
        <h5 class="text-uppercase mb-1 mt-1">Contact Us</h5>
      ...
      <!-- Social Media -->
      <div class="col-md-3">
        <h5 class="text-uppercase mb-1 mt-1">Follow Us</h5>
