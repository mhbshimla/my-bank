  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-3 text-sm">
        ...
        <a href="#" class="text-white me-3"><i class="fab fa-facebook fa-1x"></i></a>
        <a href="#" class="text-white me-3"><i class="fab fa-twitter fa-1x"></i></a>
        <a href="#" class="text-white me-3"><i class="fab fa-linkedin fa-1x"></i></a>
        <a href="#" class="text-white"><i class="fab fa-instagram fa-1x"></i></a>
      </div>
